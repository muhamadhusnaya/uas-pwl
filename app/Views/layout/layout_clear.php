...
<html
  ...
  <head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="img/OrganicstationLogo.png" />
    ...
    <!-- Page CSS -->
    <!-- Page -->
    <link rel="stylesheet" href="sneat-bootstrap-html-admin-template-free-v3.0.0/sneat-bootstrap-html-admin-template-free/assets/vendor/css/pages/page-auth.css" />
